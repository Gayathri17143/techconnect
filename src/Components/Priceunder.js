...
function App() {
  return (
    <div className='mar'>
         <Typography mb={2} ml={8} color={'#000'} fontWeight={600} textAlign={'left'}>Price Around</Typography>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6} md={4} lg={4}>
        <a href="https://example.com" style={{color:'green'}}>Laptop Under ₹45000</a>
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={4}>
        ...
        <Grid item xs={12} sm={6} md={4} lg={4}>
        <a href="https://example.com" style={{color:'green'}}>BasicPhones Under ₹20000</a>
        </Grid>
